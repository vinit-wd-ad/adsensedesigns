    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-5">
                ...
                <div class="google-review text-start mt-5 position-relative">
                    <img src="https://trophy.adsensedesigns.com/wp-content/uploads/2026/05/google-logo.png" alt="" style="width: 50px;">
                    <div class="rating">
                    ...
                    <div class="profile">
                        <a href="https://share.google/Y6oJB8dVUFvNrajLy" target="_blank">view profile <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>

            <div class="col-xl-7 col-lg-7 mt-5 mt-lg-0">
                <div class="swiper testimonial-slider testimonial-right w-100">
                            ...
                            <div class="testimonial-card-items-2">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="client-content">
                                        <h4>SWASTHBHOOMI</h4>
                                        <p> (Director) <b class="base-color">Subrata Biswas</b></p>
                        ...
                        <div class="swiper-slide wow fadeInUp px-2" data-wow-delay=".3s">
                            <div class="testimonial-card-items-2">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="client-content">
                                        <h4>GVI Hardware</h4>
                                        <p>(Director) <b class="base-color">Vinay Aggarwal</b></p>
                                        <a href="https://adsensedesigns.com">
                                            <img src="assets/img/client/images.png" alt="" width="15px">
                                            <img src="assets/img/client/google.png" alt="" width="50px">
                                            <img src="assets/img/client/verify.jpg" alt="" width="80px">
                        ...
                        <div class="swiper-slide wow fadeInUp px-2" data-wow-delay=".3s">
                            <div class="testimonial-card-items-2">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="client-content">
                                        <h4>CARGILL</h4>
                                        <p>(Strategic Marketing) <b class="base-color">Syam</b></p>
                                        <a href="https://adsensedesigns.com">
                                            <img src="assets/img/client/images.png" alt="" width="15px">
                                            <img src="assets/img/client/google.png" alt="" width="50px">
                                            <img src="assets/img/client/verify.jpg" alt="" width="80px">
                        ...
                        <div class="swiper-slide wow fadeInUp px-2" data-wow-delay=".3s">
                            <div class="testimonial-card-items-2">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="client-content">
                                        <h4>STOREFORME</h4>
                                        <p>(Head) <b class="base-color">Kanchan</b></p>
                                        <a href="https://adsensedesigns.com">
                                            <img src="assets/img/client/images.png" alt="" width="15px">
                                            <img src="assets/img/client/google.png" alt="" width="50px">
                                            <img src="assets/img/client/verify.jpg" alt="" width="80px">
                        ...
                        <div class="swiper-slide wow fadeInUp px-2" data-wow-delay=".3s">
                            <div class="testimonial-card-items-2">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="client-content">
                                        <h4>SPEDITION</h4>
                                        <p>(Operations) <b class="base-color">Harpreet Singh</b></p>
                                        <a href="https://adsensedesigns.com">
                                            <img src="assets/img/client/images.png" alt="" width="15px">
                                            <img src="assets/img/client/google.png" alt="" width="50px">
                                            <img src="assets/img/client/verify.jpg" alt="" width="80px">
