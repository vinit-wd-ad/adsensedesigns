...
if ($service_id <= 0) {
    redirect('admin/services/service-list.php', ['error' => 'Invalid Service ID']);
    exit;
}

$objService = new Database('services');
$service = $objService->find($service_id);

if (!$service) {
    redirect('admin/services/service-list.php', ['error' => 'Service not found']);
    exit;
}
...
// JSON Decoding for database array representation
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="card-title fw-semibold mb-0">Update Service SEO Details: <span class="text-primary"><?= htmlspecialchars($service['name']) ?></span></h5>
                            <a href="<?= BASE_URL ?>admin/services/service-list.php" class="btn btn-primary">
                                Services List
                            </a>
                        </div>

                        <form action="<?= BASE_URL ?>admin/classes/process_service_seo.php" method="POST">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="p-3 border rounded bg-light">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="seo_meta[keywords]" class="form-control" placeholder="e.g. corporate, services, marketing" value="<?= isset($seo_meta['keywords']) ? htmlspecialchars($seo_meta['keywords']) : '' ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="p-3 border rounded bg-light">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="og_seo[keywords]" class="form-control" placeholder="e.g. social, share, business" value="<?= isset($og_seo['keywords']) ? htmlspecialchars($og_seo['keywords']) : '' ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="p-3 border rounded bg-light">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="url" name="canonical_url" class="form-control" placeholder="https://example.com/service-slug" value="<?= htmlspecialchars($canonical_url) ?>">
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="schema_json" class="form-control" rows="5" placeholder='{"@context": "https://schema.org", "@type": "Service", ...}'><?= htmlspecialchars($schema_json) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="<?= BASE_URL ?>admin/services/service-list.php" class="btn btn-dark ms-2">Cancel</a>
                        </form>
